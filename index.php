      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav ms-auto">
            <?= $_SESSION && $_SESSION["username"] ? "<span>Bienvenue {$_SESSION["username"]} !</span>" : '<a class="nav-link" href="./views/register.php">S\'inscrire</a>' ?>
            <li class="nav-item">
              <?=
    ...
    <section class="container d-flex justify-content-center">
      ...
      ?>
        <div class="card m-3" style="width: 18rem;">
          <img class="card-img-top" src="<?= $movie->getImage_url() ?>" alt="<?= $movie->getTitle() ?>" />
          <div class="card-body">
            ...
            <a href="./views/update.php?id=<?= $movie->getId() ?>" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Modifier"><i class="fa-regular fa-pen-to-square"></i></a>
            <a href="./views/delete.php?id=<?= $movie->getId() ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Supprimer"><i class="fa-regular fa-trash-can"></i></a>
          </div>
        </div>
      <?php endforeach; ?>
    </section>
